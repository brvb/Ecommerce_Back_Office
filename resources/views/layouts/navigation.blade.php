<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark position-fixed">
    <div class="m-header">
                ...
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            ...
                            <div class="dud-logout" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
