                    ...
                    <tbody>
                        @foreach ($promotions as $promotion)
                            <tr>
                                    ...
                                    <div class="d-inline-block align-middle">
                                        <div class="d-flex">
                                            ...
                                            <div class="d-inline-block">
                                                ...
                                                <p class="text-muted m-b-0">{{ $promotion->id}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>{{ $promotion->daye }}</td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target=".bd-example-modal-lg{{ $promotion->id}}"><i class="fas fa-pen"></i></button>
                                    <button type="button" class="btn btn-sm btn-outline-primary"><i class="fas fa-file-alt"></i></button>
                                    <div class="modal fade bd-example-modal-lg{{ $promotion->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-9">
                                                            <div class="form-group text-left">
                                                                ...
                                                                <input type="text" class="form-control" id="Titulo"  value="{{ $promotion->title}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-3">
                                                            <div class="form-group text-left">
                                                                <label class="floating-label" for="Sale">Sale</label>
                                                                <input type="text" class="form-control" id="Sale" value="{{ $promotion->sale}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group text-left">
                                                                <label class="floating-label" for="description">Description</label>
                                                                <textarea class="form-control" id="description">{{ $promotion->description}}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
