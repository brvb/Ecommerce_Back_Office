                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fas fa-pen"></i></button>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group text-left">
                                                                ...
                                                                <textarea class="form-control" id="Paragrafo"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-3">
                                                            <div class="form-group text-left">
                                                                <label class="floating-label" for="old_price">Old Price</label>
                                                                <input type="text" class="form-control" id="old_price"  value="">
                                                            </div>
                                                        </div>
                                                        <div class="col-3">
                                                            <div class="form-group text-left">
